...
public class BancoUtil {
	 ...
	 * (03.07.2000 retrocedidos 1000 dias do início do processo) segundo a
	 * FEBRABAN.
	 * </p>
	 */
	 ...
	 * 
	 *<p>
	 * Calcula o fator de vencimento, com base na subtração entre a DATA DE
	 * VENCIMENTO do título e a DATA BASE , fixada em 07.10.1997 (03.07.2000
	 * retrocedidos 1000 dias do início do processo). Trata-se de um referencial
	 * numérico de 4 dígitos, situado nas quatro primeiras posições do campo
	 * “valor”, que representa a quantidade de dias decorridos da data base à
	 * data de vencimento do título.
	 *</p>
	 *<p>
	 * Os bloquetos de cobrança emitidos a partir de 1º de setembro de 2000
	 * (primeiro dia útil = 03/07/2000 - SEGUNDA) OBRIGATORIAMENTE devem conter
	 * essas características, para que quando forem capturados pela rede
	 * bancária, os sistemas possam realizar operação inversa, ou seja,
	 * adicionar à data base o fator de vencimento capturado, obtendo, dessa
	 * forma, a data do vencimento do bloqueto.<br/>
	 * 
	 * Exemplos: 03/07/2000(Fator = 1000), 05/07/2000(Fator = 1002), 01/05/2002
	 * (Fator = 1667), 05/07/2000(Fator = 1002) e 21/02/2025(Fator = 9999).
	 *</p>
	 * 
	 *<p>
	 * Observações:
	 * <ul>
	 * <li>
	 * A data base para o cálculo do fator de vencimento é 07/10/1997 (Fator de
	 * vencimento = 0).Caso a data de vencimento seja anterior a data base, uma
	 * exceção do tipo IllegalArgumentException será lançada.</li>
	 * <li>
	 * A data limite para o cálculo do fator de vencimento é 21/02/2025 (Fator
	 * de vencimento = 9999) Caso a data de vencimento seja posterior a data
	 * limite, uma exceção do tipo IllegalArgumentException será lançada.</li>
	 * </ul>
	 *</p>
	 * 
